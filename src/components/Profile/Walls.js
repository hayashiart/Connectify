// src/components/Profile/Walls.js
// Ce fichier contient le composant Walls, qui affiche une page de mur de messages dans le profil.
// Il inclut une bannière, des boutons de navigation, et un composant de mur de messages.
...
/*
 * PARTIE 2 : STYLES DU COMPOSANT WALLS
 * Cette partie définit les styles pour le conteneur, le contenu principal, et la zone du mur.
 */
const WallsContainer = styled.div` // Crée un style nommé "WallsContainer" pour une balise <div>
...
const MainContent = styled.div` // Crée un style nommé "MainContent" pour une balise <div>
  display: flex; // Utilise Flexbox pour organiser les boutons et le mur côte à côte
...
const WallsContent = styled.div` // Crée un style nommé "WallsContent" pour une balise <div>
...
/*
 * PARTIE 3 : LOGIQUE DU COMPOSANT WALLS
 * Cette partie définit comment le composant affiche la page du mur de messages dans le profil.
 */
/*
 * Description de la fonction Walls :
 * Cette fonction est le composant principal qui affiche une page de mur de messages dans le profil.
 * Elle inclut une bannière, des boutons de navigation, et un composant de mur.
 * Arguments :
 ...
 * Retour :
 * - Retourne le JSX qui affiche la page avec la bannière, les boutons, le mur, et le footer.
 */
const Walls = ({ isLoggedIn, onLogout }) => { // Crée une fonction "Walls" avec des props "isLoggedIn" et "onLogout"
  /*
   * PARTIE 3.1 : RENDU JSX DU COMPOSANT
   * Cette sous-partie affiche la page avec ses différentes sections.
   */
  return (
    <WallsContainer> {/* Conteneur principal de la page */}
      <ProfileBannerComponent /> {/* Affiche la bannière de profil */}
      <MainContent> {/* Conteneur pour les boutons et le mur */}
        <ProfileButtonBlock /> {/* Affiche les boutons de navigation */}
        <WallsContent> {/* Zone dédiée au mur de messages */}
          <MessageWallComponent /> {/* Affiche le composant de mur de messages */}
        </WallsContent>
      </MainContent>
 ...
 */
export default Walls; // Exporte la fonction "Walls" pour qu’elle soit réutilisable ailleurs