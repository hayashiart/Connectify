// src/components/Profile/Video.js
// Ce fichier contient le composant Video, qui affiche une page de vidéos dans le profil.
// Il inclut une bannière, des boutons de navigation, et un composant de GIFs (utilisé comme substitut pour les vidéos).
...
import GifComponent from "../Shared/GifComponent"; // Importe le composant GifComponent pour afficher des GIFs (substitut pour vidéos)

/*
 * PARTIE 2 : STYLES DU COMPOSANT VIDEO
 * Cette partie définit les styles pour le conteneur, le contenu principal, et la zone des vidéos.
 */
const VideoContainer = styled.div` // Crée un style nommé "VideoContainer" pour une balise <div>
...
const MainContent = styled.div` // Crée un style nommé "MainContent" pour une balise <div>
  display: flex; // Utilise Flexbox pour organiser les boutons et les vidéos côte à côte
...
const VideoContent = styled.div` // Crée un style nommé "VideoContent" pour une balise <div>
...
/*
 * PARTIE 3 : LOGIQUE DU COMPOSANT VIDEO
 * Cette partie définit comment le composant affiche la page de vidéos dans le profil.
 */
/*
 * Description de la fonction Video :
 * Cette fonction est le composant principal qui affiche une page de vidéos dans le profil.
 * Elle inclut une bannière, des boutons de navigation, et un composant de GIFs (substitut pour vidéos).
 * Arguments :
 ...
 * Retour :
 * - Retourne le JSX qui affiche la page avec la bannière, les boutons, les vidéos, et le footer.
 */
const Video = ({ isLoggedIn, onLogout }) => { // Crée une fonction "Video" avec des props "isLoggedIn" et "onLogout"
  /*
   * PARTIE 3.1 : RENDU JSX DU COMPOSANT
   * Cette sous-partie affiche la page avec ses différentes sections.
   */
  return (
    <VideoContainer> {/* Conteneur principal de la page */}
      <ProfileBannerComponent /> {/* Affiche la bannière de profil */}
      <MainContent> {/* Conteneur pour les boutons et les vidéos */}
        <ProfileButtonBlock /> {/* Affiche les boutons de navigation */}
        <VideoContent> {/* Zone dédiée aux vidéos */}
          <GifComponent /> {/* Affiche le composant de GIFs comme substitut */}
        </VideoContent>
      </MainContent>
 ...
 */
export default Video; // Exporte la fonction "Video" pour qu’elle soit réutilisable ailleurs